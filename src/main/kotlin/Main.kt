...
//    var kth=findKthElementFromEnd(4,head)
//    println(kth.name)
//
//
...
fun createLinkedList(): Node{
    ...
    var node3=Node("Angeth")
    var node4=Node("Cynthia")
    var node5=Node("Regina")
    var node6=Node("Kanoro")
    var node7=Node("Victoria")
    var node8=Node("Yekebedi")
